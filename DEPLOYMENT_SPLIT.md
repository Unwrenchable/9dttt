...
✅ **Performance**: Static files served by Vercel's edge CDN (faster)  
✅ **Scalability**: Backend can scale independently  
✅ **Cost**: Frontend is free on Vercel, backend free tier on Render  
✅ **Reliability**: If one service is down, the other still works  
✅ **Development**: Deploy frontend/backend separately  
